...
class NetworkHelper {
  ...
  Future<dynamic>? uploadBankInformation(
    BuildContext context,
    String orderId,
    ...
    http.Response response;
    String url = kApiPaymentUrl;

    Map<String, String> body = Map();

    body = _appendParamIntoBody(body, "fields[$addressKey]", addressValue);
    body = _appendParamIntoBody(body, "order_id", orderId);
    body = _appendParamIntoBody(body, "payment_method_id", paymentMethodId);

    var fileStream;
    var fileLength;

    if (zipFileValue != null) {
      fileStream = http.ByteStream(zipFileValue.openRead().cast());
      fileLength = await zipFileValue.length();
    }
    ...
    response = await _multiPartPostRequest(
      ...
      body: body,
      fileList: [
        if (zipFileValue != null && fileStream != null && fileLength != null)
          http.MultipartFile(
            "fields[$zipFileKey]",
            fileStream,
            fileLength,
            filename: basename(zipFileValue.path),
          )
      ],
    );
  ...
  Future<CategoryListResponse>? getProductCategories(
    ...
    postFix = _appendParamIntoPostfix(postFix, kHierarchy, hierarchy);
    postFix = _appendParamIntoPostfix(postFix, kParentId, parentId);
  ...
  Future<http.Response> _multiPartPostRequest({
    ...
    required List<http.MultipartFile> fileList,
  }) async {
    http.Response response;
  ...
  // ignore: missing_return
  Future<PaymentMethodListResponse>? getAbandonedPaymentMethods(
  ...
  // ignore: missing_return
  Future<dynamic>? abandonedPayment(
    BuildContext context,
    int? paymentMethodId,
    int? orderId,
  ) async {
    http.Response response;
    String url = kApiAbandonedPayment;
  ...
  // ignore: missing_return
  Future<OrderSummaryPaginatedListResponse>? getAbondanedOrderHistory(
      BuildContext context, int? page) async {
    http.Response response;
    String url = kApiAbondanedOrderUrl;
