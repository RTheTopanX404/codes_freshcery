...
// #F2558A 7101E3
const Color kAccentColor = Color(0xFFF2558A);
...
const Color kWidgetAccentColor = Color(0xFF262626);
...
const String kDevBaseUrl = 'http://45.77.187.45/zenmart/';
const String kLiveBaseUrl = 'https://xyz.com/';
const String kBaseUrl = "https://freshcery.circlecreative.dev/"; // kDevBaseUrl;
...
const String kApiPaymentUrl = kApiBaseUrl + 'payment';
const String kApiAbandonedPayment = kApiBaseUrl + 'payment/create';
const String kApiAbondanedOrderUrl = kApiBaseUrl + 'order?abandoned=1';
...
const String kApiGetTransactionList = kApiBaseUrl +
    'transaction?type&order_by=id&order=desc&paginate=1&perpage=15&limit';
...
const String kHierarchy = 'hierarchy';
const String kParentId = 'parent_id';
...
const String kPaymentMethodId = 'payment_method_id';
