...
class _OrderStepsPageState extends State<OrderStepsPage> {
  ...
  late DatabaseReference _deliveryManPositionRef;
  ...
  void didChangeDependencies() {
    ...
    _stepList = [
      Step(
        isActive:
            widget.orderDetails!.status! >= 0 && widget.orderDetails!.status! < 4,
        title: Text(
          getString('pending')!,
      ...
      Step(
        isActive:
            widget.orderDetails!.status! >= 1 && widget.orderDetails!.status! < 4,
        title: Text(
      ...
      Step(
        isActive:
            widget.orderDetails!.status! >= 2 && widget.orderDetails!.status! < 4,
        title: Text(
      ...
      Step(
        isActive:
            widget.orderDetails!.status! >= 3 && widget.orderDetails!.status! < 4,
        title: Text(
          getString('completed')!,
          style: _stepTitleTextStyle,
        ),
          ...
          child: isLoading
              ...
              : Column(
                  children: [
                    ...
                    if (widget.orderDetails!.status == 0 ||
