...
import 'package:azzoa_grocery/data/remote/model/gallery.dart';
...
import 'package:azzoa_grocery/util/lib/common_example_wrapper.dart';
...
class _ProductDetailsPageState extends State<ProductDetailsPage> {
  ...
  late HashMap<String?, List<AttributeContent>> attributeMap;
  late HashMap<String?, int> selectionMap;
  ...
  Widget buildBannerList(List<Gallery> bannerList) {
  ...
  Widget buildBanner(Gallery item) {
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
              ...
              FutureBuilder(
                ...
                builder: (
                  ...
                  if (snapshot.hasData &&
                    ...
                    Review review =
                        snapshot.data!.data!.jsonObject!.data!.first;
