                    ...
                    if (snapshot.hasData) {
                      ...
                      if (widget.reviewableType.toLowerCase() == "product") {
                        SingleProductResponse? response =
                            snapshot.data as SingleProductResponse?;
                      ...
                      } else if (widget.reviewableType.toLowerCase() ==
                          "shop") {
                        SingleShopResponse? response =
                            snapshot.data as SingleShopResponse?;
                                ...
                                children: <Widget>[
                                    ...
                                    Padding(
                                      ...
                                      child: CircleAvatar(
                                        ...
                                        backgroundImage: NetworkImage(
                                          widget.orderDetails!.consignments!
                                              .first.deliveryMan!.avatar!,
                                        ),
                                      ),
                                    ),
                                  if (widget.reviewableType == "order")
                                    Container(
                                      decoration: BoxDecoration(
                                        ...
                                        color:
                                            Color(0xFFFEB71E).withOpacity(0.2),
                                      ),
                                      child: Padding(
                                  ...
                                  if (widget.reviewableType == "delivery_man")
                                    Padding(
                                      ...
                                      child: Text(
                                        widget.orderDetails!.consignments!.first
                                            .deliveryMan!.name!,
                                        style: TextStyle(
                                          color: Colors.black,
                                          fontSize: 20,
