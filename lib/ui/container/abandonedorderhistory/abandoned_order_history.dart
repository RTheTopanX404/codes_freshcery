...
import 'package:azzoa_grocery/ui/orders/details/abandoned_order_details.dart';
...
class AbandonedOrderHistoryPage extends StatefulWidget {
  @override
  _AbandonedOrderHistoryPageState createState() =>
      _AbandonedOrderHistoryPageState();
}

class _AbandonedOrderHistoryPageState extends State<AbandonedOrderHistoryPage> {
  ...
  Future<void> _getList(
    ...
    try {
      ...
      OrderSummaryPaginatedListResponse? response =
          await NetworkHelper.on().getAbondanedOrderHistory(
        context,
        page,
      );
