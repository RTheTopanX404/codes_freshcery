...
class _UpdateAddressPageState extends State<UpdateAddressPage> {
  ...
  void initState() {
    ...
    _latitudeController!.text = widget.item.latitude!;
    _longitudeController!.text = widget.item.longitude!;
    _addressLine1Controller!.text = widget.item.streetAddress_1!;
    _addressLine2Controller!.text = widget.item.streetAddress_2!;
    _cityController!.text = widget.item.city!;
    _stateController!.text = widget.item.state!;
    _countryController.text = widget.item.country!;
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 0.0,
          title: Text(
            getString('edit_address_toolbar_title')!,
            style: TextStyle(
              color: Colors.black,
              fontSize: 20.0,
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            buildTextFormField(
                              ...
                              hint:
                                  getString('add_new_address_address_line_1')!,
                              inputType: TextInputType.streetAddress,
                            ),
                            buildTextFormField(
                              controller: _addressLine2Controller,
                              hint:
                                  getString('add_new_address_address_line_2')!,
                              inputType: TextInputType.streetAddress,
                            ),
                            buildTextFormField(
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                if (showPlacePicker)
                  InkWell(
                    //TODO : Research show location picker
                    onTap: () async {
  ...
  void _updateAddress() async {
    if (_validateUserData()) {
      ...
      try {
        AddressResponse? response = await NetworkHelper.on().updateAddress(
          context,
          widget.pageTag,
        ...
        if (response != null &&
            ...
            response.status == 200) {
          ToastUtil.show(getString('edit_address_updated')!);
